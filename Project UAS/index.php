...
<section class="home" id="home">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <a href="#registration" class="btn">Registrasi</a>
      </div>
...
<section class="teachers" id="teachers">
   ...
   <h1 class="heading">pendiri <span>codeGuide</span></h1>
...
<section class="reviews" id="reviews">
   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <p>Overall saya sangat terbantu dengan bergabung ke komunitas code guide ini, karena saya sangat dibantu soal dunia IT yang sebelumnya tidak saya pahami, sehingga sekarang saya bisa bekerja dan terjun ke dunia IT, pokoknya good banget deh.</p>
            <div class="user">
